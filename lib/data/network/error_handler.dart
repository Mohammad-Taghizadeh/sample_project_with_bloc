  ...
  Failure _handleError(DioError error){
    switch(error.type){
      ...
      case DioErrorType.receiveTimeout:
        return DataSource.RESEIVE_TIMEOUT.getFailure();
...
extension DataSourceExtension on DataSource {
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.RESEIVE_TIMEOUT:
        return Failure(ResponseCode.RESEIVE_TIMEOUT, ResponseMessage.RESEIVE_TIMEOUT);
...
class ResponseCode {
  ...
  static const int RESEIVE_TIMEOUT = -4;
...
class ResponseMessage {
  ...
  static const String RESEIVE_TIMEOUT = "Time out error ,try again later";
